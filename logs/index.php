                        ...
                        <div data-lov-id="src/pages/Logs.tsx:97:14" data-lov-name="div"
                            ...
                            <div data-lov-id="src/components/ui/table.tsx:7:4" data-lov-name="div"
                                ...
                                <?php 
                                        ...
                                        $sql =  mysqli_query($connection, "SELECT * FROM `history`  WHERE `user` = '$id' ORDER BY id DESC");
                                        ...
                                        if($sql && mysqli_num_rows($sql) > 0){
                                            ...
                                            while($row = mysqli_fetch_assoc($sql)){
                                                ...
                                                echo '<td class="p-4 align-middle [&:has([role=checkbox])]:pr-0"><div '. $statusClass .'>'. $status_text .'</div></td>';
                                                echo '</tr>';
                                            }
                                            echo '</tbody>';

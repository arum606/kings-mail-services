            ...
            <div data-lov-id="src/pages/SendEmail.tsx:216:6" data-lov-name="div"
                ...
                <div data-lov-id="src/pages/SendEmail.tsx:222:8" data-lov-name="Card"
                    ...
                    <div data-lov-id="src/pages/SendEmail.tsx:229:10" data-lov-name="CardContent"
                        ...
                        <form class="space-y-6" method="POST" id="send_form">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex gap-2">
                                    <textarea
                                        class="flex min-h-[80px] w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                                        id="recipients" rows="3" name="recipients"
                                        placeholder="Paste emails separated by commas"></textarea>
                                    <button
                                        ...
                                        id="check_email" name="check_email" type="button"
                                        onclick="validateEmails('test')" id="emailForm">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="lucide lucide-plus h-4 w-4"
                            ...
                            <!-- Submit Button -->
                            <button type="submit" style="display:none" id="send_email" name="send_email"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="lucide lucide-send h-4 w-4" fill="none"
                        ...
                        <script>
                        function validateEmails(mode, evt) {
                            ...
                            if (mode === "submit") {
                                if (invalidEmails.length > 0) {
                                    ...
                                    // prevent the default form submit if this was triggered by a click event
                                ...
                                // All good - submit form (handled via fetch)
                            }
                        }
                        ...
                        function showToast(message, type = "info") {
                            Toastify({
                                ...
                                gravity: "top",
                                position: "right",
                                backgroundColor: type === "success" ? "#22c55e" : (type === "error" ?
                                    "#ef4444" : "#3b82f6"),
                                stopOnFocus: true
                            }).showToast();
                        }
                                ...
                                form.addEventListener('submit', (event) => {
                                    ...
                                    fetch('<?php echo $domain; ?>compose/mailer.php', {
                                        ...
                                        .then(data => {
                                            ...
                                            html: `
                                                <div style="font-size: 16px; text-align: left; margin-bottom: 8px;">
                                                <strong>Sent:</strong> ${sentCount} <br>
                                                <strong>Failed:</strong> ${failedCount}
                                                </div>
                                                <div style="font-size: 12px; color: blue; border-top: 1px solid #eee; padding-top: 5px;">
                                                    ${message}
                                                </div>
                                            `,
                                            width: '300px',

        ...
        <div data-lov-id="src/pages/Dashboard.tsx:71:4" data-lov-name="div"
            ...
            <div data-lov-id="src/pages/Dashboard.tsx:73:6" data-lov-name="div"
                ...
                <?php 
                    ...
                    $sql1 = mysqli_query($connection, "SELECT * FROM `history` WHERE DATE(`date`) = CURDATE()  AND `status` = 'success' AND `user` = '$id' ");
                    $sql2 = mysqli_query($connection, "SELECT * FROM `history` WHERE DATE(`date`) = CURDATE()  AND `status` = 'failed' AND `user` = '$id' ");

                    $total_sent = mysqli_num_rows($sql1) + mysqli_num_rows($sql2);
                    $failed = mysqli_num_rows($sql2);
                ...
                <div class="grid gap-4 md:grid-cols-3 mb-8">
                    <div class="rounded-lg border text-card-foreground shadow-sm transition-all duration-300 bg-card hover:shadow-elevated">
                        <div class="space-y-1.5 p-6 flex flex-row items-center justify-between pb-2">
                            <h3 class="tracking-tight text-sm font-medium text-muted-foreground">Total Sent Today</h3>
                    ...
                    <div class="rounded-lg border bg-card text-card-foreground shadow-sm transition-all duration-300 bg-gradient-to-br from-success/10 to-success/5 border-success/20">
                        <div class="space-y-1.5 p-6 flex flex-row items-center justify-between pb-2">
                            <h3 class="tracking-tight text-sm font-medium text-muted-foreground">Successfully Sent Today</h3>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check h-4 w-4 text-success">
                    ...
                    <div class="rounded-lg border bg-card text-card-foreground shadow-sm transition-all duration-300 bg-gradient-to-br from-destructive/10 to-destructive/5 border-destructive/20">
                        <div class="space-y-1.5 p-6 flex flex-row items-center justify-between pb-2">
                            <h3 class="tracking-tight text-sm font-medium text-muted-foreground">Failed Today</h3>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-x h-4 w-4 text-destructive">
                                <circle cx="12" cy="12" r="10"></circle>

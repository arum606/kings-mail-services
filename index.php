...
<body>
    ...
    <div id="root">
        ...
        <div data-lov-id="src/components/auth/AuthForm.tsx:78:4" data-lov-name="div"
            data-component-path="src/components/auth/AuthForm.tsx" data-component-line="78"
            data-component-file="AuthForm.tsx" data-component-name="div"
            data-component-content="%7B%22className%22%3A%22min-h-screen%20flex%20items-center%20justify-center%20bg-gradient-to-br%20from-primary%2F5%20via-background%20to-primary%2F10%20p-4%22%7D"
            class="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/5 via-background to-primary/10 p-4">
            <div data-lov-id="src/components/auth/AuthForm.tsx:79:6" data-lov-name="Card"
                data-component-path="src/components/auth/AuthForm.tsx" data-component-line="79"
                data-component-file="AuthForm.tsx" data-component-name="Card"
                data-component-content="%7B%22className%22%3A%22w-full%20max-w-md%20shadow-elevated%22%7D"
                class="rounded-lg border bg-card text-card-foreground shadow-sm w-full max-w-md shadow-elevated">
                <div data-lov-id="src/components/auth/AuthForm.tsx:80:8" data-lov-name="CardHeader"
                    data-component-path="src/components/auth/AuthForm.tsx" data-component-line="80"
                    data-component-file="AuthForm.tsx" data-component-name="CardHeader"
                    data-component-content="%7B%22className%22%3A%22space-y-1%22%7D"
                    class="flex flex-col p-6 space-y-1">
                    <h3 data-lov-id="src/components/auth/AuthForm.tsx:81:10" data-lov-name="CardTitle"
                        data-component-path="src/components/auth/AuthForm.tsx" data-component-line="81"
                        data-component-file="AuthForm.tsx" data-component-name="CardTitle"
                        data-component-content="%7B%22text%22%3A%22Email%20Sender%22%2C%22className%22%3A%22text-3xl%20font-bold%20text-center%20bg-gradient-to-r%20from-primary%20to-primary%2F70%20bg-clip-text%20text-transparent%22%7D"
                        class="tracking-tight text-3xl font-bold text-center bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">
                        Mailer</h3>
                    <p data-lov-id="src/components/auth/AuthForm.tsx:84:10" data-lov-name="CardDescription"
                        data-component-path="src/components/auth/AuthForm.tsx" data-component-line="84"
                        data-component-file="AuthForm.tsx" data-component-name="CardDescription"
                        data-component-content="%7B%22className%22%3A%22text-center%22%7D"
                        class="text-sm text-muted-foreground text-center">Welcome back! Sign in to continue</p>
                </div>
                <div data-lov-id="src/components/auth/AuthForm.tsx:88:8" data-lov-name="CardContent"
                    data-component-path="src/components/auth/AuthForm.tsx" data-component-line="88"
                    data-component-file="AuthForm.tsx" data-component-name="CardContent" data-component-content="%7B%7D"
                    class="p-6 pt-0">
                    ...
                    <script>
                        ...
                        form.addEventListener('submit', (event) => {
                            ...
                            fetch('<?php echo $domain; ?>server/api/login.php', {
                                    method: 'POST',
                                    body: formData
                                })
                                .then(response => {
                                ...
                                .then(data => {
                                    ...
                                    if (data.status == 'success') {
                                        ...
                                        setTimeout(() => {
                                            ...
                                            location.href = '<?php echo $domain; ?>dashboard/';
                                        }, 3000);

            ...
            <div data-lov-id="src/pages/Profile.tsx:119:4" data-lov-name="div" data-component-path="src/pages/Profile.tsx"
                ...
                <div data-lov-id="src/pages/Profile.tsx:121:6" data-lov-name="div"
                    ...
                    <div data-lov-id="src/pages/Profile.tsx:122:8" data-lov-name="div"
                        ...
                        <h2 data-lov-id="src/pages/Profile.tsx:123:10" data-lov-name="h2"
                            ...
                            class="text-3xl font-bold tracking-tight">Profile Settings</h2>
                        <p data-lov-id="src/pages/Profile.tsx:124:10" data-lov-name="p"
                            data-component-path="src/pages/Profile.tsx" data-component-line="124"
                            data-component-file="Profile.tsx" data-component-name="p"
                            data-component-content="%7B%22text%22%3A%22Update%20your%20account%20information%22%2C%22className%22%3A%22text-muted-foreground%20mt-1%22%7D"
                            class="text-muted-foreground mt-1">Update your account information</p>
                    </div>
                    <div data-lov-id="src/pages/Profile.tsx:127:8" data-lov-name="div"
                        ...
                        <div data-lov-id="src/pages/Profile.tsx:128:10" data-lov-name="Card"
                            ...
                            <div data-lov-id="src/pages/Profile.tsx:129:12" data-lov-name="CardHeader"
                                ...
                                <h3 data-lov-id="src/pages/Profile.tsx:130:14" data-lov-name="CardTitle"
                                    data-component-path="src/pages/Profile.tsx" data-component-line="130"
                                    data-component-file="Profile.tsx" data-component-name="CardTitle"
                                    data-component-content="%7B%22text%22%3A%22Change%20Email%22%7D"
                                    class="text-2xl font-semibold leading-none tracking-tight">Change Email</h3>
                                <p data-lov-id="src/pages/Profile.tsx:131:14" data-lov-name="CardDescription"
                                    data-component-path="src/pages/Profile.tsx" data-component-line="131"
                                    data-component-file="Profile.tsx" data-component-name="CardDescription"
                                    data-component-content="%7B%22text%22%3A%22Current%20email%3A%22%7D"
                                    class="text-sm text-muted-foreground">Current email: <?php echo $login_email ?></p>
                            </div>
                            <div data-lov-id="src/pages/Profile.tsx:135:12" data-lov-name="CardContent"
                                ...
                                <form class="space-y-4" method="POST" action="" >
                                    <div class="space-y-2">
                                        <label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70" for="newEmail">New Email Address</label>
                                        <input type="email" id="newEmail" placeholder="" name = "newEmail" required="" value=""
                                ...
                                <?php 
                                    ...
                                    if (isset($_POST['update_email'])) {
                                        ...
                                        if ($new_email !== $login_email) {
                                            // Update the email in the database
                                            $update_query = "UPDATE user SET email = ? WHERE id = ?";
                                            ...
                                            if ($stmt->execute()) {
                                                ...
                                                echo "<script>
                                                    Swal.fire({
                                                        icon: 'success',
                                                        title: 'Email Updated',
                                                        text: 'Email updated successfully to " . addslashes(htmlspecialchars($new_email)) . "',
                                                ...
                                                echo "<script>
                                                    Swal.fire({
                                                        icon: 'error',
                                                        title: 'Update Failed',
                                                        text: 'Error updating email. Please try again later.',
                                                        confirmButtonText: 'OK'
                                                    });
                                                </script>";
                                            }
                                            ...
                                            // SweetAlert warning for same email
                                            echo "<script src='https://cdn.jsdelivr.net/npm/sweetalert2@11'></script>";
                                            echo "<script>
                                                Swal.fire({
                                                    icon: 'warning',
                                                    title: 'No Change',
                                                    text: 'The new email address is the same as the current one.',
                                                    confirmButtonText: 'OK'
                                                });
                                            </script>";
                                        }
                        ...
                        <div data-lov-id="src/pages/Profile.tsx:165:10" data-lov-name="Card"
                            data-component-path="src/pages/Profile.tsx" data-component-line="165"
                            data-component-file="Profile.tsx" data-component-name="Card" data-component-content="%7B%7D"
                            class="rounded-lg border bg-card text-card-foreground shadow-sm">
                            <div data-lov-id="src/pages/Profile.tsx:166:12" data-lov-name="CardHeader"
                                data-component-path="src/pages/Profile.tsx" data-component-line="166"
                                data-component-file="Profile.tsx" data-component-name="CardHeader"
                                data-component-content="%7B%7D" class="flex flex-col space-y-1.5 p-6">
                                <h3 data-lov-id="src/pages/Profile.tsx:167:14" data-lov-name="CardTitle"
                                    data-component-path="src/pages/Profile.tsx" data-component-line="167"
                                    data-component-file="Profile.tsx" data-component-name="CardTitle"
                                    data-component-content="%7B%22text%22%3A%22Change%20Password%22%7D"
                                    class="text-2xl font-semibold leading-none tracking-tight">Change Password</h3>
                                <p data-lov-id="src/pages/Profile.tsx:168:14" data-lov-name="CardDescription"
                                    data-component-path="src/pages/Profile.tsx" data-component-line="168"
                                    data-component-file="Profile.tsx" data-component-name="CardDescription"
                                    data-component-content="%7B%22text%22%3A%22Enter%20a%20new%20password%20for%20your%20account%22%7D"
                                    class="text-sm text-muted-foreground">Enter a new password for your account</p>
                            </div>
                            <div data-lov-id="src/pages/Profile.tsx:172:12" data-lov-name="CardContent"
                                data-component-path="src/pages/Profile.tsx" data-component-line="172"
                                data-component-file="Profile.tsx" data-component-name="CardContent"
                                data-component-content="%7B%7D" class="p-6 pt-0">
                                ...
                                <?php
                                        ...
                                        if (isset($_POST['update_password'])) {
                                            ...
                                            if ($new_password === $confirm_password) {
                                                ...
                                                // SweetAlert error for mismatched passwords
                                                echo "<script src='https://cdn.jsdelivr.net/npm/sweetalert2@11'></script>";
                                                echo "<script>
                                                    Swal.fire({
                                                        icon: 'error',
